...
def test_default_configuration_settings_set(attck_configuration):
    ...
    assert os.path.abspath(
        os.path.expanduser(os.path.expandvars(attck_configuration().config_file_path))
    ) == os.path.abspath(os.path.expanduser(os.path.expandvars("~/pyattck/config.yml")))
    assert os.path.abspath(
        os.path.expanduser(os.path.expandvars(attck_configuration().config.data_path))
    ) == os.path.abspath(os.path.expanduser(os.path.expandvars(default_config_data.get("data_path"))))
...
def test_configuration_save_config(attck_configuration):
    ...
    assert (
        os.path.abspath(os.path.expanduser(os.path.expandvars(attck.config.config.data_path)))
        == attck_configuration().config.data_path
    )
