...
class PreAttckObject(object):
    ...
    def __init__(self, **kwargs):
        ...
        Arguments:
            kwargs (dict) -- Takes the MITRE PRE-ATT&CK Json object as
                             a kwargs values
        """
    ...
    def set_relationships(self, attck_obj):
        """
        Generates relationships within attck_obj based on
        a defined relationship from MITRE ATT&CK
    ...
    def _set_attribute(self, obj, name):
        ...
        Returns:
            (str) -- Returns either the value of the attribute requested
                     or returns 'null'
        """
        try:
            value = obj.get(name)
    ...
    def _set_reference(self, obj):
        ...
        MITRE PRE-ATT&CK Framework json object
        ...
        Returns:
            (dict) -- Returns a dict containing the following key/value pairs
                ...
                description (str) -- The MITRE PRE-ATT&CK Framework description
